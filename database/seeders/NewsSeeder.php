...
class NewsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        News::create([
            ...
            'excerpt' => 'Warga Desa Duren bergotong royong membersihkan lingkungan sekitar balai desa dan jalan utama.',
        ...
        News::create([
            ...
            'excerpt' => 'Pemerintah Desa Duren akan melaksanakan penyaluran Bantuan Langsung Tunai (BLT) Dana Desa Tahap III.',
        ...
        News::create([
            ...
            'excerpt' => 'Dalam rangka meningkatkan kapasitas pelaku usaha mikro, kecil, dan menengah di desa.',
