    ...
    <div class="detail-container">
        ...
        <div class="detail-main">
            <article class="article-card">
                ...
                <!-- ARTICLE FOOTER ACTIONS: TOMBOL BAGIKAN -->
                <div class="article-footer-actions">
                    <a href="{{ route('news') }}" class="btn-back-to-news">
                        <i class="fa-solid fa-arrow-left"></i> Kembali ke Berita
                    </a>
                    <button type="button" class="btn-share-trigger" data-title="{{ $article->title }}" data-url="{{ url()->current() }}" title="Bagikan Berita">
