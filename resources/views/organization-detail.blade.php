    ...
    <div class="detail-container">
        ...
        <div class="main-content-column">
                        ...
                        <div class="leader-row">
                            <div class="member-card" style="width: 240px; border-color: var(--primary); background: #eff6ff;">
                                <div class="member-photo-wrapper" style="border-color: #dbeafe;">
                                    <img src="{{ $leader->photo ? (Str::startsWith($leader->photo, 'http') ? $leader->photo : asset($leader->photo)) : asset('img/default-avatar.svg') }}" alt="{{ $leader->name }}" class="member-photo">
                                </div>
                            ...
                            @foreach($staff as $member)
                                <div class="member-card">
                                    <div class="member-photo-wrapper">
                                        <img src="{{ $member->photo ? (Str::startsWith($member->photo, 'http') ? $member->photo : asset($member->photo)) : asset('img/default-avatar.svg') }}" alt="{{ $member->name }}" class="member-photo">
                                    </div>
            ...
            <div style="margin-top: 40px; border-top: 1px solid var(--border-color); padding-top: 25px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 15px;">
                <a href="{{ route('organizations') }}" style="color: var(--text-muted); text-decoration: none; font-weight: 700; display: inline-flex; align-items: center; gap: 8px;">
                    <i class="fa-solid fa-arrow-left"></i> Kembali ke Lembaga Kemasyarakatan
                </a>
        ...
        <div class="sidebar-column">
            <div class="sidebar-card">
                ...
                <div class="info-list">
                    ...
                    <div class="info-item">
                        ...
                        <div class="info-text-wrapper">
                            ...
                            <div class="info-val">{{ $institution->address ?? 'Wilayah Desa Duren, Kec. Tengaran, Kab. Semarang, 50775' }}</div>
                        </div>
                    </div>
                ...
                @if($institution->clean_contact)
                    @php
                        $ormasWaGreeting = 'Halo ' . ($institution->contact_person ? $institution->contact_person : 'Pengurus') . ', saya ingin bertanya informasi seputar ' . $institution->name . ' di Desa Duren.';
                    @endphp
                    <div style="margin-top: 20px;">
                        <a href="https://wa.me/{{ $institution->clean_contact }}?text={{ urlencode($ormasWaGreeting) }}" target="_blank" style="background-color: #25d366; color: #fff; text-decoration: none; display: flex; align-items: center; justify-content: center; gap: 8px; padding: 12px 20px; border-radius: var(--radius-md); font-weight: 700; transition: var(--transition);">
                ...
                <div style="margin-top: 12px;">
                    <button type="button" class="btn-share-trigger" data-title="{{ $institution->name }}" data-url="{{ url()->current() }}" style="width: 100%; padding: 12px 20px; font-size: 0.95rem; justify-content: center; border-radius: var(--radius-md);">
                        <i class="fa-solid fa-share-nodes"></i> Bagikan Organisasi
                    </button>
                </div>
            </div>
        </div>
