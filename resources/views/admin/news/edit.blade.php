    ...
    <div class="card" style="max-width: 900px; margin: 0 auto;">
        ...
        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" id="image_caption" name="image_caption" class="form-control" placeholder="Contoh: Ilustrasi kegiatan warga. (Foto: Dok. Pribadi)" value="{{ old('image_caption', $news->image_caption) }}">
