...
<div class="card" style="max-width: 900px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.announcements.update', $announcement->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" placeholder="Masukkan judul atau perihal pengumuman resmi..." value="{{ old('title', $announcement->title) }}" required>
            @error('title')
        ...
        <div class="form-group">
            ...
            <textarea id="content" name="content" class="form-control @error('content') is-invalid @enderror" placeholder="Tuliskan rincian lengkap isi pengumuman atau surat edaran..." required style="min-height: 250px;">{{ old('content', $announcement->content) }}</textarea>
            @error('content')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
