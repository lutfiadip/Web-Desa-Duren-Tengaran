...
<div class="card" style="max-width: 900px; margin: 0 auto;">
    ...
    <form action="{{ route('admin.announcements.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <span style="font-size: 0.8rem; color: var(--text-muted); display: block; margin-top: 5px;">Format file: PDF, DOC, DOCX, XLS, XLSX, ZIP, RAR, PNG, JPG. Maksimal 5MB.</span>
            @error('document_file')
                <div class="invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" id="expired_at" name="expired_at" class="form-control @error('expired_at') is-invalid @enderror" value="{{ old('expired_at') }}">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
            <div class="form-group">
                ...
                <div style="display: flex; align-items: center; gap: 10px; padding: 5px 0;">
                    ...
                    <label class="switch">
                        <input type="hidden" name="is_alert" id="is_alert-input" value="{{ old('is_alert', '0') }}">
                        <input type="checkbox" id="is_alert-toggle" {{ old('is_alert') == '1' ? 'checked' : '' }} onchange="document.getElementById('is_alert-input').value = this.checked ? '1' : '0'">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; align-items: center; gap: 10px; padding: 5px 0;">
                    ...
                    <label class="switch">
                        <input type="hidden" name="is_active" id="is_active-input" value="{{ old('is_active', '1') }}">
                        <input type="checkbox" id="is_active-toggle" {{ old('is_active', '1') == '1' ? 'checked' : '' }} onchange="document.getElementById('is_active-input').value = this.checked ? '1' : '0'">
                        <span class="slider"></span>
                    </label>
