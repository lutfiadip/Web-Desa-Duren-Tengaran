        ...
        <div class="card" style="margin: 0;">
            ...
            <form action="{{ route('admin.institutions.members.store', $institution->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Masukkan nama lengkap pengurus..." required>
                    @error('name')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="position" id="position" class="form-control @error('position') is-invalid @enderror" value="{{ old('position') }}" placeholder="Masukkan jabatan pengurus (contoh: Ketua, Sekretaris, Bendahara)..." required>
                    @error('position')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
