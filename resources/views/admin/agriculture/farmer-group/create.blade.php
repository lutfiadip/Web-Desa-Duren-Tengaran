    ...
    <div class="card" style="max-width: 600px;">
        ...
        <form action="{{ route('admin.agriculture.farmer-group.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="sector" id="sector" class="form-control @error('sector') is-invalid @enderror" value="{{ old('sector') }}" placeholder="Masukkan bidang usaha kelompok (contoh: Tanaman Pangan, Hortikultura, Peternakan)..." required>
                @error('sector')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" name="dusun" id="dusun" class="form-control @error('dusun') is-invalid @enderror" value="{{ old('dusun') }}" placeholder="Masukkan wilayah kerja atau nama dusun..." required>
                @error('dusun')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
