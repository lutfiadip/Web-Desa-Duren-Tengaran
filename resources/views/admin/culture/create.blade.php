        ...
        <form action="{{ route('admin.culture.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" id="location" name="location" class="form-control"
                        placeholder="Masukkan lokasi pentas, sanggar, atau dusun..." value="{{ old('location') }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="implementation_time" name="implementation_time" class="form-control"
                        placeholder="Masukkan waktu atau jadwal pelaksanaan kegiatan..." value="{{ old('implementation_time') }}" required>
                </div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group">
                    ...
                    <input type="text" id="contact_person" name="contact_person" class="form-control"
                        placeholder="Masukkan nama narahubung atau ketua paguyuban..." value="{{ old('contact_person') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="contact" name="contact" class="form-control"
                        placeholder="Masukkan nomor telepon atau WhatsApp aktif (contoh: 081234567890)..." value="{{ old('contact') }}">
            ...
            <div class="form-group">
                ...
                <textarea id="description" name="description" class="form-control"
                    placeholder="Tuliskan latar belakang sejarah, ciri khas gerakan, alat musik, atau makna tradisi..."
                    required style="min-height: 150px;">{{ old('description') }}</textarea>
            </div>
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px; padding: 5px 0;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" id="featured-toggle" {{ old('is_featured') == '1' ? 'checked' : '' }}
                ...
                <div class="form-group">
                    ...
                    <div style="display: flex; align-items: center; gap: 10px; padding: 5px 0;">
                        ...
                        <label class="switch">
                            ...
                            <input type="checkbox" id="status-toggle" {{ old('status') === 'published' ? 'checked' : '' }}
