    ...
    <div class="card" style="max-width: 900px; margin: 0 auto;">
        ...
        <form action="{{ route('admin.culture.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="title">Nama Kebudayaan</label>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div class="form-group">
                    <label for="location">Tempat Penyelenggaraan</label>
                    <input type="text" id="location" name="location" class="form-control"
                        placeholder="Masukkan nama sanggar atau lokasi..." value="{{ old('location') }}" required>
                </div>
            ...
            <div class="form-group">
                ...
                <input type="text" id="implementation_time" name="implementation_time" class="form-control"
                    placeholder="Masukkan waktu pelaksanaan kegiatan..." value="{{ old('implementation_time') }}" required>
            </div>

            <div class="form-group">
                <label for="description">Deskripsi Lengkap Kebudayaan</label>
                <textarea id="description" name="description" class="form-control"
                    placeholder="Tuliskan latar belakang sejarah, ciri khas gerakan, alat musik, atau makna tarian..."
