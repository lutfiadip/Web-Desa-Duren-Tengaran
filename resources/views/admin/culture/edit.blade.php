        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            ...
            <div class="form-group">
                ...
                <div style="display: flex; align-items: center; gap: 10px; padding: 5px 0;">
                    ...
                    <label class="switch">
                        <input type="hidden" name="status" id="status-input" value="{{ old('status', $culture->status) }}">
                        <input type="checkbox" id="status-toggle" {{ old('status', $culture->status) === 'published' ? 'checked' : '' }} onchange="document.getElementById('status-input').value = this.checked ? 'published' : 'draft'">
