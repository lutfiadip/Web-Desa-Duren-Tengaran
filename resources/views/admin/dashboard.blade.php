...
<style>
    ...
    /* --- COLOR VARIANTS --- */
    .icon-news { background-color: #eff6ff; color: #2563eb; }
    .icon-reg { background-color: #fef3c7; color: #d97706; }
    .icon-off { background-color: #f0fdf4; color: #16a34a; }
    .icon-umkm { background-color: #faf5ff; color: #9333ea; }
    .icon-tour { background-color: #ecfeff; color: #0891b2; }
    .icon-cult { background-color: #fff1f2; color: #e11d48; }
...
@section('content')
    ...
    <div class="welcome-card">
        ...
        <p>Anda sedang berada di Panel Administrasi Website Resmi Desa Duren, Kecamatan Tengaran. Kelola semua konten, informasi publik, potensi wisata, produk UMKM, dan profil desa dari satu dashboard pusat.</p>
    ...
    <div class="quick-actions">
        ...
        <div class="card" style="margin-bottom: 0;">
            <div class="card-header">
                <h2><i class="fa-solid fa-circle-info" style="color: var(--primary-light); margin-right: 8px;"></i> Informasi Umum</h2>
            </div>
            <div style="font-size: 0.95rem; line-height: 1.8; color: var(--text-muted);">
                <p style="margin-bottom: 15px;">Semua data yang diunggah atau disunting di panel admin ini akan langsung tercermin secara real-time pada portal publik Desa Duren.</p>
                <p style="margin-bottom: 15px;">Gunakan berkas gambar berformat <strong>JPG, JPEG, PNG, WEBP</strong> untuk foto/gambar dengan ukuran maksimal 2MB per gambar agar loading website publik tetap optimal.</p>
                <p>Jika ada kendala teknis atau kebutuhan penyesuaian sistem lebih lanjut, silakan hubungi tim IT pengembang.</p>
            </div>
        </div>
    </div>
@endsection
