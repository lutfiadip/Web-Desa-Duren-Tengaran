    ...
    <div class="card" style="padding: 30px; background-color: var(--white); border: 1px solid var(--border-color); border-radius: var(--radius-lg); box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05); max-width: 600px;">
        <form action="{{ route('admin.statistics.types.store') }}" method="POST">
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="name" id="name" class="form-control" value="{{ old('name') }}" placeholder="Contoh: Agama, Pendidikan Terakhir, Pekerjaan" required style="width: 100%; padding: 10px 14px; border: 1px solid var(--border-color); border-radius: var(--radius-md); outline: none;">
            </div>
            ...
            <div class="form-group" style="margin-bottom: 20px;">
                ...
                <input type="text" name="slug" id="slug" class="form-control" value="{{ old('slug') }}" placeholder="Contoh: agama, pendidikan-terakhir. Kosongkan untuk generate otomatis." style="width: 100%; padding: 10px 14px; border: 1px solid var(--border-color); border-radius: var(--radius-md); outline: none;">
