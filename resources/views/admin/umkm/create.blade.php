        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
            <div class="form-group">
                ...
                <select id="is_featured" name="is_featured" class="form-control" required>
                    <option value="0" {{ old('is_featured') == '0' ? 'selected' : '' }}>Bukan Unggulan (Tampil Biasa)</option>
                    <option value="1" {{ old('is_featured') == '1' ? 'selected' : '' }}>Ya, Jadikan Unggulan (Tampil di Beranda/Sorotan)</option>
                </select>
            </div>
