    ...
    <form action="{{ route('admin.transparency.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div style="background: #f8fafc; border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 20px; margin-bottom: 20px;">
            ...
            <div class="form-group">
                ...
                <input type="number" name="revenue_realization" id="revenue_realization" class="form-control" placeholder="0" readonly style="background-color: #e2e8f0; font-weight: 700; color: var(--text-dark);">
            </div>
        ...
        <div style="background: #f8fafc; border: 1px solid var(--border-color); border-radius: var(--radius-md); padding: 20px; margin-bottom: 20px;">
            ...
            <div class="form-group">
                ...
                <input type="number" name="spending_realization" id="spending_realization" class="form-control" placeholder="0" readonly style="background-color: #e2e8f0; font-weight: 700; color: var(--text-dark);">
            </div>
