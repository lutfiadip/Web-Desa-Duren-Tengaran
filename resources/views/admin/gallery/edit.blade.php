        ...
        <form action="{{ route('admin.gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data" style="padding: 20px;">
            ...
            <div class="form-group" style="margin-bottom: 25px;">
                ...
                <div style="display: flex; align-items: center; gap: 10px; padding: 5px 0;">
                    ...
                    <label class="switch">
                        <input type="hidden" name="is_featured" id="featured-input" value="{{ old('is_featured', $gallery->is_featured ? '1' : '0') }}">
                        <input type="checkbox" id="featured-toggle" {{ old('is_featured', $gallery->is_featured ? '1' : '0') == '1' ? 'checked' : '' }} onchange="document.getElementById('featured-input').value = this.checked ? '1' : '0'">
